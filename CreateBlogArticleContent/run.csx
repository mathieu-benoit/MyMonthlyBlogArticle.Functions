...
static Regex AppDevKeyWordsRegex = new Regex("(App Service|Functions|Logic Apps|DevOps|VSTS|Visual Studio|Application Insights|Web|Media|Xamarin|Mobile|ASP.NET|CDN|Java|.NET|Azure Search|Azure Redis Cache|DevTest Labs|API Management|Container|Service Fabric|ACS|Sitecore|Video Indexer|TFS|PHP|Kubernetes|AKS|OpenShift|App Center|DevOps|Open Service Broker|Bot Framework|Bot Service|Azure Artifacts|Azure Pipelines|Git|WordPress|FHIR)");
static Regex InfraKeyWordsRegex = new Regex("(Azure Stack|ExpressRoute|Virtual Machine|VM|Azure Batch|Availability Zones|Azure Automation|Azure Site Recovery|Azure Storage|Azure Log Analytics|OMS|Azure Monitor|Azure Cost Management|Load Balancer|DNS|Network|Traffic Manager|VNet|StorSimple|Backup|Service Health|Blockchain|Azure Migrate|Reserved Instance|Operations Management Suite|Azure Service Health|Log Analytics|Azure File|SAP|Block Blob|Managed Disks|premium file|Azure Advisor)");
static Regex DataAIKeyWordsRegex = new Regex("(Cosmos DB|CosmosDB|SQL|IoT|Cognitive Services|PowerBI|Power BI|Data Lake|Azure Analysis Services|Database|HDInsight|Machine Learning|Data Factory|Stream Analytics|Time Series|MySQL|PostgreSQL|Data Warehouse|Event Grid|Event Hub|Service Bus|Databricks|QnAMaker|TensorFlow|Azure Maps)");
static Regex SecurityKeyWordsRegex = new Regex("(Security Center|GDPR|Azure Active Directory|AAD|AD DS|SOC|Azure Information Protection|Azure AD|EMS|Traffic Analytics|Azure Advanced Threat Protection|DDoS|Azure Security Center|Cloud App Security|Application Security Groups|Intune|Azure Sphere)");
...
static string GetBlogArticleContent(DateTime currentDate)
{
    ...
    //Header
    builder.Append($"<br /><div class=\"separator\" style=\"clear:both;text-align:center;\"><a href=\"https://3.bp.blogspot.com/-dBD4StBYYlc/WzP-wBWVWaI/AAAAAAAARbw/2-YkW5uNtOsSWYL1AI0BxUoKpiqnI7hlACLcBGAs/s1600/IMG_20180627_113115.jpg\" imageanchor=\"1\"style=\"margin-left:1em; margin-right:1em;\"><img border=\"0\" data-original-height=\"987\" data-original-width=\"1600\" height=\"197\" src =\"https://3.bp.blogspot.com/-dBD4StBYYlc/WzP-wBWVWaI/AAAAAAAARbw/2-YkW5uNtOsSWYL1AI0BxUoKpiqnI7hlACLcBGAs/s1600/IMG_20180627_113115.jpg\" width=\"320\" /></a ></div >");
